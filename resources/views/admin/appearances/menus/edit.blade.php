...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.appearance.menu.update')" type="put" :validate="true">
                <x-input type="hidden" name="menu[id]" :value="$menu->id" />
                <x-input type="hidden" name="json_menu_items" />
                <div class="row justify-content-center">
                    @include('admin.appearances.menus.forms.edit-left')
                    @include('admin.appearances.menus.forms.edit-right')
                </div>
