            ...
            <div class="card mb-3">
                <div class="card-header">
                    <a href="#page"
                        ...
                        <h4 class="mb-0 text-black">@lang('page')</h4>
                    ...
                    <div class="card-body wrap-list-checkbox">
                        @foreach ($pages as $item)
                            <x-input-checkbox :depth="$item->depth" class="input-add-menu-item" name="add_menu_item" 
                                ...
                                :data-reference-type="get_class($item)" 
                                :data-titletype="trans('page')" 
                            />
                        @endforeach
                    </div>
                    <div class="card-footer text-end">
                        <button type="button" class="btn btn-add-item btn-icon p-2" data-target="#page"><i class="ti ti-plus"></i>{{ __('Thêm vào menu') }}</button>
                    </div>
                </div>
            </div>
            <div class="card mb-3">
                ...
                <div id="catPost" class="panel-collapse collapse">
                    ...
                    <div class="card-footer text-end">
                        <button type="button" class="btn btn-add-item btn-icon p-2" data-target="#catPost"><i class="ti ti-plus"></i>{{ __('Thêm vào menu') }}</button>
                    </div>
                </div>
            </div>
            <div class="card mb-3">
                ...
                <div id="customLink" class="panel-collapse collapse">
                    ...
                    <div class="card-footer text-end">
                        <button type="button" class="btn btn-add-item-custom-link btn-icon p-2" data-target="#customLink">
        ...
        <div class="col-md-8">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <p><i>@lang('displayLocation')</i></p>
                        </div>
                        <div class="col-md-8">
                            @foreach ($menu_locations as $key => $label)
                                <x-input-checkbox name="locations[]" 
                                    :checked="$menu->locations->pluck('location')->toArray()"
                                    :label="$label" 
                                    :value="$key"
                                />
                            @endforeach
